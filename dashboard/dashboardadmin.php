...
<head>
    ...
    <title>Dashboard Admin - Mitra Jaya Supermarket</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="sidebar">
        ...
        <ul class="menu">
            <li><a href="dashboardadmin.php" class="active"><span class="menu-icon">📊</span> Dashboard</a></li>
    ...
    <div class="main-content">
        ...
        <div class="welcome-card">
            ...
            <p>Kelola semua data master supermarket dengan mudah</p>
        </div>
