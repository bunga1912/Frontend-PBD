...
try {
    ...
    $sql = "SELECT p.idpengadaan, p.timestamp, p.subtotal_nilai, p.ppn, p.total_nilai,
                   p.user_iduser, p.vendor_idvendor, p.status,
    ...
    // Query untuk mendapatkan detail item pengadaan
    $sql_detail = "SELECT dp.iddetail_pengadaan, dp.harga_satuan, dp.jumlah, dp.sub_total,
...
<head>
    ...
    <title>Detail Pengadaan #<?php echo $id; ?> - Mitra Jaya Supermarket</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .status-a { background: #fff3cd; color: #856404; }
        .status-b { background: #d1ecf1; color: #0c5460; }
        ...
        <div class="content-card">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        <?php 
                            ...
                            $statusText = '';
                            if ($status == 'A') $statusText = 'Pending';
                            else if ($status == 'B') $statusText = 'Diproses';
                            else if ($status == 'C') $statusText = 'Selesai';
                        ?>
                ...
                <div class="info-item">
                    ...
                    <div class="info-value"><?php echo htmlspecialchars($pengadaan['username']); ?></div>
                </div>
            </div>
            ...
            <?php if (empty($detail_items)): ?>
                <p style="text-align: center; color: #999; padding: 40px;">Tidak ada item dalam pengadaan ini</p>
            <?php else: ?>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right price-text">Rp <?php echo number_format($item['sub_total'], 0, ',', '.'); ?></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
            ...
            <div class="summary-box">
                <div class="summary-row">
                    <span>Subtotal:</span>
                    <span class="price-text">Rp <?php echo number_format($pengadaan['subtotal_nilai'], 0, ',', '.'); ?></span>
                </div>
                <div class="summary-row">
                    <span>PPN (10%):</span>
                    <span class="price-text">Rp <?php echo number_format($pengadaan['ppn'], 0, ',', '.'); ?></span>
                </div>
                <div class="summary-row total">
                    <span>TOTAL NILAI:</span>
                    <span>Rp <?php echo number_format($pengadaan['total_nilai'], 0, ',', '.'); ?></span>
                </div>
            </div>
            
            <div class="toolbar">
                <a href="indexpengadaan.php" class="btn btn-back">← Kembali ke Daftar</a>
            </div>
        </div>
        <?php endif; ?>
    </div>
