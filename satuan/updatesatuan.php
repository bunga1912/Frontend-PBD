...
<head>
    ...
    <title>Edit Satuan - Mitra Jaya Supermarket</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="form-card">
            <h2 class="page-title">✏️ Edit Data Satuan</h2>

            <div class="info-box">
                <strong>📏 ID Satuan: <?php echo $satuan['idsatuan']; ?></strong>
                Mengubah data: <?php echo htmlspecialchars($satuan['nama_satuan']); ?>
            </div>
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="text" id="nama_satuan" name="nama_satuan" required 
                           value="<?php echo htmlspecialchars($satuan['nama_satuan']); ?>"
                ...
                <div class="form-group">
                    ...
                    <select id="status" name="status" required>
                        ...
                        <option value="0" <?php echo ($satuan['status'] == 0) ? 'selected' : ''; ?>>Nonaktif</option>
                    </select>
                </div>
                ...
                <div class="button-group">
                    ...
                    <button type="button" class="btn btn-secondary" onclick="window.location.href='indexsatuan.php'">
                        ↩️ Kembali
                    </button>
                </div>
            </form>
