...
<head>
    ...
    <title>Tambah Role - Mitra Jaya Supermarket</title>
    <style>
        ...
        <div class="form-card">
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="text" id="nama_role" name="nama_role" required placeholder="Contoh: manager, supervisor, staff">
                    <div class="input-hint">Masukkan nama role sesuai dengan tugas dan tanggung jawab</div>
                </div>
                <div class="button-group">
                    <button type="submit" class="btn btn-primary">💾 Simpan</button>
                    <button type="button" class="btn btn-secondary" onclick="window.location.href='indexrole.php'">↩️ Kembali</button>
                </div>
            </form>
        </div>
    </div>
